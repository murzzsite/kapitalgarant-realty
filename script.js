(() => {
  // ===== CONFIG =====
  const LEAD_ENDPOINT = 'https://lead-relay.leestygpt.workers.dev/lead/HYPNK68K9T';
  ...
  const targets = document.querySelectorAll(
    '.adv, .srv, .step, .aud, .offer, .team-card, .city, .doc-card, .move__inner, .contact-card, .faq__item, .form, .hero__card'
  );
